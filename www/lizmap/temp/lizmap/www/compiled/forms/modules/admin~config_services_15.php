...
filemtime('C:\webserver\www\lizmap\lizmap/modules/admin/forms/config_services.form.xml') > 1648133822){ return false;
}else{
...
$ctrl->help=jLocale::get('admin~admin.form.admin_services.lizmapPluginAPIURL.help');
$this->addControl($ctrl);
