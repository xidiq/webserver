...
filemtime('C:\webserver\www\lizmap\lizmap/modules/view/templates/map_edition.tpl') > 1648133822){ return false;
} else {
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tabdigitization">
                    ...
                    <lizmap-reverse-geom class="btn btn-small"
                        data-original-title="<?php echo jLocale::get('view~edition.geomtool.reversegeom.title'); ?>"></lizmap-reverse-geom>
