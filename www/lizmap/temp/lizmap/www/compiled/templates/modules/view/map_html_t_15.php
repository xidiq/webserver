...
filemtime('C:\webserver\www\lizmap\lizmap/modules/view/templates/map.tpl') > 1648133822){ return false;
} else {
...
<div id="content">
  ...
  <div id="map-content">
    ...
    <div id="overview-box">
      <lizmap-overviewmap title="<?php echo jLocale::get('view~map.overviewmap.hover'); ?>"></lizmap-overviewmap>
      <div id="overview-bar">
