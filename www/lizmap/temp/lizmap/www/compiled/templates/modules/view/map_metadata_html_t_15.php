...
filemtime('C:\webserver\www\lizmap\lizmap/modules/view/templates/map_metadata.tpl') > 1648133822){ return false;
} else {
...
?>    <div>
      <div>
        <p>
          <img src="<?php jtpl_function_html_jurl( $t,'view~media:illustration', array('repository'=>$t->_vars['repository'],'project'=>$t->_vars['project']));?>" alt="project image" class="img-polaroid liz-project-img" width="200" height="200" loading="lazy">
