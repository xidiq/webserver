...
filemtime('C:\webserver\www\lizmap\lizmap/modules/admin/templates/config_services.tpl') > 1648133822){ return false;
} else {
    ...
    <div>
        ...
        <table class="table services-table">
            <?php if(is_array(array('uploadedImageMaxWidthHeight'))){
                ...
                $t->_privateVars['__form'] = array('uploadedImageMaxWidthHeight');
                $ctrls_to_display=null;
                $ctrls_notto_display = null;
            }
if (!isset($t->_privateVars['__formbuilder'])) {
    ...
    <div>
        ...
        <table class="table services-table">
            <?php if(is_array(array('qgisServerVersion', 'wmsServerURL', 'wmsPublicUrlList', 'relativeWMSPath', 'wmsMaxWidth', 'wmsMaxHeight', 'lizmapPluginAPIURL'))){
                ...
                $t->_privateVars['__form'] = array('qgisServerVersion', 'wmsServerURL', 'wmsPublicUrlList', 'relativeWMSPath', 'wmsMaxWidth', 'wmsMaxHeight', 'lizmapPluginAPIURL');
                $ctrls_to_display=null;
                $ctrls_notto_display = null;
            }
if (!isset($t->_privateVars['__formbuilder'])) {
