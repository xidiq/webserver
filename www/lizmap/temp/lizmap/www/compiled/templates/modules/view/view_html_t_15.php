...
filemtime('C:\webserver\www\lizmap\lizmap/modules/view/templates/view.tpl') > 1648133822){ return false;
} else {
  ...
  <li class="liz-repository-project-item">
    ...
    <div class="thumbnail">
      <div class="liz-project">
        <img width="250" height="250" loading="lazy" src="<?php echo $t->_vars['p']->img; ?>" alt="project image" class="liz-project-img">
