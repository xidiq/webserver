...
filemtime('C:\webserver\www\lizmap\lizmap/modules/view/templates/popup_all_features_table.tpl') > 1640097255){ return false;
} else {
 require_once('C:\webserver\www\lizmap\lizmap/plugins/tpl/common/modifier.featurepopup.php');
