...
filemtime('C:\webserver\www\lizmap\lizmap/var/themes/default/jauthdb_admin/crud_view.tpl') > 1620802989){ return false;
} else {
 require_once('C:\webserver\www\lizmap\lizmap/plugins/tpl/html/function.formdatafull_bootstrap.php');
...
<?php jtpl_function_html_formdatafull_bootstrap( $t,$t->_vars['form']);?>
