...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\www\lizmap\lib/jelix-modules/jacl2db/daos/jacl2groupsofuser.dao.xml') > 1616160725)){ return false;
}
else {
...
public function update ($record){
     throw new jException('jelix~dao.error.update.impossible',array('jacl2db~jacl2groupsofuser','C:\webserver\www\lizmap\lib/jelix-modules/jacl2db/daos/jacl2groupsofuser.dao.xml'));
 }
